...
def load_background_batch():
    ...
    test_dir = "C:/Users/ADMIN/Downloads/CancerClassificationShap-20240205T133543Z-001/CancerClassificationShap/test"
    batch_data = []
...
def load_all_models():
    ...
    for each_model in os.listdir('C:/Users/ADMIN/Downloads/CancerClassificationShap-20240205T133543Z-001/CancerClassificationShap/models'):
        model = load_model(f'C:/Users/ADMIN/Downloads/CancerClassificationShap-20240205T133543Z-001/CancerClassificationShap/models/{each_model}', compile=False)
